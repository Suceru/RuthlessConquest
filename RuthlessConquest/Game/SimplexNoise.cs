...
namespace Game
{
    public static class SimplexNoise
    {
        ...
        {
            x = (x << 13 ^ x);
            return (x * (x * x * 15731 + 789221) + 1376312589 & int.MaxValue) / 2.14748365E+09f;
        }
        ...
        public static float Noise(float x, float y, float z)
        {
            ...
            float num5 = (num2 + num3 + num4) * 0.166666672f;
            ...
            float num18 = num9 - num12 + 0.166666672f;
            float num19 = num10 - num13 + 0.166666672f;
            float num20 = num11 - num14 + 0.166666672f;
        ...
        public static float OctavedNoise(float x, float frequency, int octaves, float frequencyStep, float amplitudeStep)
        {
            float num = 0f;
            float num2 = 0f;
            float num3 = 1f;
        ...
        public static float OctavedNoise(float x, float y, float frequency, int octaves, float frequencyStep, float amplitudeStep)
        {
            float num = 0f;
            float num2 = 0f;
            float num3 = 1f;
        ...
        public static float OctavedNoise(float x, float y, float z, float frequency, int octaves, float frequencyStep, float amplitudeStep)
        {
            float num = 0f;
            float num2 = 0f;
            float num3 = 1f;
